...
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (2,'1999-04-19', 'MAN', 'Drowning and submersion due to being washed overboard from (nonpowered) inflatable craft, initial encounter', 'mflicker1@boston.com', 'EN', 'Andrew', 'Flicker', 2);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (3,'1998-06-25', 'WOMAN', 'Fracture of neck, unspecified', 'uvenditti2@linkedin.com', 'LV', 'Anna', 'Venditti', 3);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (4,'2010-01-28', 'OTHER', 'Burn of first degree of right toe(s) (nail), initial encounter', 'vyanov3@globo.com', 'LV', 'Eve', 'Yanov', 4);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (5,'2001-10-06', 'WOMAN', 'Blister (nonthermal), unspecified lesser toe(s), initial encounter', 'roconnor4@drupal.org', 'EN', 'Penelope', 'Connor', 5);
