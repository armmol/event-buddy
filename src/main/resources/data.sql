...
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (1,'1999-12-06', 'MAN', 'Laceration without foreign body of nose, sequela', 'beastop0@tripadvisor.com', 'EN','Steve', 'Eastop', 1);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (2,'1999-04-19', 'MAN', 'Drowning and submersion due to being washed overboard from (nonpowered) inflatable craft, initial encounter', 'mflicker1@boston.com', 'EN', 'Andrew', 'Flicker', 6);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (3,'1998-06-25', 'WOMAN', 'Fracture of neck, unspecified', 'uvenditti2@linkedin.com', 'LV', 'Anna', 'Venditti', 7);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (4,'2010-01-28', 'OTHER', 'Burn of first degree of right toe(s) (nail), initial encounter', 'vyanov3@globo.com', 'LV', 'Eve', 'Yanov', 8);
...
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'fbotterman1@unicef.org', 'Quatz', '635-636-8732', 2);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'vcastagne2@mapy.cz', 'Edgeify', '141-431-4124', 3);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'gdrache3@mtv.com', 'Youspan', '715-810-1953', 4);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'gdrache3@mtv.com', 'Youspan', '715-810-1953', 5);
...
insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'nulla ultrices aliquet maecenas leo odio condimentum id luctus nec molestie sed justo pellentesque viverra pede ac', '2022-05-30 21:42:17', 'FESTIVAL', 'Nylon Hedgehog Cactus', '2022-08-13 01:11:37', 2, 3);
...
insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'a suscipit nulla elit ac nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at ipsum ac tellus semper interdum mauris ullamcorper purus', '2022-01-09 12:36:24', 'FESTIVAL', 'Mottled Spurge', '2022-01-20 18:44:49', 2, 2);
insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'vulputate nonummy maecenas tincidunt lacus at velit vivamus vel nulla eget eros elementum pellentesque quisque porta volutpat erat quisque erat eros', '2022-01-15 13:36:09', 'FESTIVAL', 'Partridgeberry', '2022-06-18 22:27:22', 1, 2);
insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'sem fusce consequat nulla nisl nunc nisl duis bibendum felis sed', '2022-09-19 18:02:47', 'FESTIVAL', 'Mazus', '2022-01-17 19:09:38', 2, 1);
