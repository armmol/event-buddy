...
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (1,'1974-12-06', 'MAN', 'I’m very creative, communicative, and flexible', 'beastop0@tripadvisor.com', 'EN','Steve', 'Eastop', 1);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (2,'1999-04-19', 'MAN', 'My hobbies are reading books and working out', 'mflicker1@boston.com', 'EN', 'Andrew', 'Flicker', 2);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (3,'1998-06-25', 'WOMAN', 'My favourite hobby is travelling because I love discovering new cities and places around the world. ', 'uvenditti2@linkedin.com', 'LV', 'Anna', 'Venditti', 3);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (4,'2010-01-28', 'OTHER', 'I like spending time in nature and capture all the wonderful moments of beauty with my camera', 'vyanov3@globo.com', 'LT', 'Eve', 'Yanov', 4);
Insert into VISITORS_TABLE (VISITOR_ID, DATE_OF_BIRTH, GENDER, VISITOR_DESCRIPTION, VISITOR_EMAIL, VISITOR_LANGUAGE, VISITOR_NAME, VISITOR_SURNAME, USER_COL) values (5,'2001-10-06', 'WOMAN', 'I love trying new cuisine. As soon as a new restaurant opens, I would like to find a new friend to join in on the experience.', 'roconnor4@drupal.org', 'EN', 'Penelope', 'Connor', 5);
...
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'eventagency@agency.io', 'Event Agency', '836-710-1765', 6);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'fbotterman1@unicef.org', 'Eight Event', '635-636-8732', 6);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'vcastagne2@mapy.cz', 'Laboratorium', '141-431-4124', 7);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'gdrache3@mtv.com', 'TMF Production', '715-810-1953', 8);
insert into ORGANIZERS_TABLE ( ORGANIZER_EMAIL, ORGANIZER_NAME, PHONE_NUMBER, USER_COL) values ( 'jledgister4@photobucket.com', 'Bravo Events', '367-805-7317', 7);

insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'Christmas is approaching, and one of the signs testifying to this is the Old Town Christmas Fair with sweet-smelling mulled wine, roasted almonds, glittering glazed gingerbread and local handcraft.', '2022-11-27 22:44:26', 'MARKET', 'Old Town Christmas Fair', '2023-01-01 08:26:31', 2, 3);
insert into EVENT_TABLE ( DESCRIPTION, END_DATE, GENRE, NAME, START_DATE, ADDRESS_COL, ORG_COL) values ( 'Visit the park which has the largest exhibition of ice sculptures in the Baltics, and where musical shows, demonstrations of sculpture creation, and various activities for children will be organized..', '2022-12-30 21:42:17', 'FESTIVAL', 'International Ice Sculpture Festival', '2023-03-13 01:11:37', 2, 5);
...
Insert into ATTENDANCE_TABLE (EVENT_COL, VISIT_COL) values (2, 5);

Insert into MATCH_TABLE (ATT1_COL, ATT2_COL) values (2, 3);
Insert into MATCH_TABLE (ATT1_COL, ATT2_COL) values (2, 4);
Insert into MATCH_TABLE (ATT1_COL, ATT2_COL) values (2, 5);
